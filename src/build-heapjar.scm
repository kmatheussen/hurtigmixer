...
(define (find-heap-file)
  (if #f
      (open-binary-input-file "/home/kjetil/hurtigmixer/src/sisc-heap-org.jar")
...
(define (build-heap-jar . output)
  (let ([outfile (open-binary-output-file
    ...
    (c-display "heapanchor:" (->string (get-resource <sisc.boot.heap-anchor> (->jstring "HeapAnchor.class"))))
    (c-display "heapfile:"  (->string (find-heap (java-null <sisc.interpreter.app-context>)
						 (java-null <java.net.URL>))))
